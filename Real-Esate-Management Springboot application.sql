...
insert into user (id, name, phone_number, designation, email_id, password, address, district, state) values ('UNR_Admin_1', 'Rakshana', 7339263883, 'Admin' , 'raksha@gmail.com', 'Raksha@12', '66A, Kalai nagar 3rd street', 'Madurai', 'Tamil Nadu');
