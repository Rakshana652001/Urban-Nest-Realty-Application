...
<h3>Customers</h3>
<form class="form-inline my-2 my-lg-0" action="CustomerSearch" method="get">
	<label class="search">Search: <input type="text" name="id"  placeholder="Search By Name" class="form-control mr-sm-2" ></label>
</form>
<table border="1">
	<thead>
		<tr>
